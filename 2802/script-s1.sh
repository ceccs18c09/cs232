pdftotext -layout result_s1.pdf

grep -A2 'CHN18CS' result_s1.txt > a.txt
...
join students.txt cgp_s1.txt > sgpf_s1.txt
rm a.txt a1.txt a2.txt a3.txt a4.txt af.txt gp.txt cgp_s1.txt result_s1.txt
